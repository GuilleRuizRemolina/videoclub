        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200" style="background-color: black">
                    <form action="<?php echo e(route('peliculas.anadir')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!--valor id que se debe pasar oculto para saber el propietario-->
                        <input type="hidden" name="propietario_id" value="<?php echo e($propietario_id); ?>" />
...
<?php endif; ?>
<?php /**PATH C:\xampp2021\htdocs\videoclub\resources\views/peliculas/nueva.blade.php ENDPATH**/ ?>