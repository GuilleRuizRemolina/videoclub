...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div style="position:absolute;left:12%;top:58%">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200" style="background-color: black">
                    <form action="{{route('peliculas.anadir')}}" method="POST" enctype="multipart/form-data">
                        ...
                        position:absolute;left:17%;top:34%" value="{{ old('anio') }}"/>
                        ...
                        style="background-color: #121212;border-style: solid;border-width: 2px;color:white;width:90px;height:35px;
                        position:absolute;left:56%;top:56%" value="{{ old('copias') }}"/>

                        <br><br><br><br><br><br><br><br><input type="submit" value="Crear pelicula"
                        style="background-color: #063b21;border-style: solid;border-width: 2px;color:white;width:180px;height:35px;
                        position:absolute;left:42%;top:78%"/>
                    </form>
                </div>
            </div>
        </div>
